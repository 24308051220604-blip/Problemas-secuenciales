...
10 peogramas de toledo
| Campo | Información |
|-------|-------------|
| Nombre completo |[Alondra Dayren Villarreal Baca ] |
| Número de control | [24308051220604] |
| Grupo | [F] |
| Grado | [4to] |
| Escuela | [Cbtis No.122] |
| Especialidad | [programacion] |

## 📘 Información del Ejercicio
- Título del ejercicio: [Problemas secuenciales]
- Descripción:  
  [en este ejercicio lo que hacemos es crear diferentes programas que nos ayuden a solucionar problemas que tengan que ver con (sumas , restas, multiplicacion, divicion, etc)en los cuales edvemos usar (.html, .js, .css)para poder crear el diseño, la paguina web, y la operacion]
